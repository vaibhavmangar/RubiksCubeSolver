...
int main() {
    ...
    // IDA* SOLVER ---------------------------------------------------------------------------------------------------
        //this will not work because we changed the overloding as cube and file
    //it previous version without any pattern dB small idAstar
    ...
    string fileName = "/Users/vaibhav/CLionProjects/RubiksCubeSolver/Database/cornerDepth2V1.txt";
    //
    //    //Code to create Corner Database
    // CornerDBMaker dbMaker(fileName, 0x99);// given till max depth 7
    // dbMaker.bfsAndStore();
    //
    RubiksCubeBitboard cube;
    auto shuffleMoves = cube.randomShuffleCube(13);//working fine
    cube.print();
