...
CornerPatternDatabase::CornerPatternDatabase(uint8_t init_val) : PatternDatabase(100179840, init_val) {}//here out of bound error so  increase size
//more details google permutation indexer maths
...
//this is how ranking done 3^7= 2189
